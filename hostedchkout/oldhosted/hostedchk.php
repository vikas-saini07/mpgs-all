...
//FOR SRC.......>>> CURLOPT_POSTFIELDS => "apiOperation=CREATE_CHECKOUT_SESSION&merchant=$merchant&apiUsername=$apiUsername&apiPassword=$apipassword&order.currency=$currency&order.id=$order_id&order.amount=$amount&interaction.operation=AUTHORIZE&interaction.merchant.url=$rwurl&interaction.merchant.name=$merchant",
#CURLOPT_POSTFIELDS => "apiOperation=CREATE_CHECKOUT_SESSION&merchant=$merchant&apiUsername=$apiUsername&apiPassword=$apipassword&order.currency=$currency&order.id=$order_id&order.amount=$amount&interaction.operation=NONE&interaction.timeout=600&interaction.timeoutUrl=$timeout",
CURLOPT_POSTFIELDS => "apiOperation=CREATE_CHECKOUT_SESSION&merchant=$merchant&apiUsername=$apiUsername&apiPassword=$apipassword&order.currency=$currency&order.id=$order_id&order.amount=$amount&interaction.operation=PURCHASE&interaction.timeout=600&interaction.timeoutUrl=$timeout",
...
console.log(url);
//reference = () => {return "TESTORDER12345" + Math.floor(Math.random() * 1000 + 1 + 8)};
//orderref = reference;
           ...
           function afterRedirect(data) {
            ...
            function completeCallback(resultIndicator, sessionVersion) {
                //       console.log('completeCallback');
                  ...
                  //window.location.href = "https://ech-10-168-129-136.mastercard.int/mpgstest/hostedchkout/complete.html";
            ...
            function cancelCallback() {
                  if (self == top) {
                      ...
                      // top.location = self.location;
                       top.location = "https://ech-10-168-129-136.mastercard.int/mpgstest/hostedchkout/cancel.html";
                  }
